...
echo -ne "$(build_arch_art)<sep>$(build_stat_widget)<sep><sep>$(build_fortune_widget | fmt -w 150 -s)<sep><sep><sep>" | python ${base}/gen-screen.py -m 150 -c 30 -r 2 -t 2 -l 3 -s "<sep>"
# { build_arch_art;
#   echo -n "<sep>";
#   build_stat_widget;
#   echo -n "<sep><sep>";
